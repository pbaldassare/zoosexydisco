  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden pb-24 pt-[calc(var(--header-h)+4rem)]">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-wall/40 via-wall/80 to-wall" aria-hidden />
        <div className="container-site relative grid gap-12 md:grid-cols-12">
          <div className="md:col-span-5">
            <h1 className="tube tube-pink text-3xl">{c("newsletter.title")}</h1>
            <p className="mt-6 max-w-prose text-ink-dim md:text-lg">{c("newsletter.body")}</p>
            <div className="wash-panel mt-10 flex gap-4 rounded-card border border-pink/35 p-6">
              <Gift className="size-6 shrink-0 text-pink" aria-hidden />
